...
const EMOJI_DESCRIPTIONS = {
    ...
    '🍌': 'a curved yellow banana', '🫐': 'blueberries', '🍈': 'a sweet melon',
    '🥥': 'a coconut', '🥑': 'an avocado', '🍆': 'a purple eggplant',
    '🥔': 'a brown potato', '🥕': 'an orange carrot', '🌽': 'an ear of corn',
    '🌶️': 'a red chili pepper', '🫑': 'a green bell pepper', '🥒': 'a green cucumber',
    '🥬': 'fresh green lettuce', '🧅': 'a brown onion', '🧄': 'a bulb of garlic',
    '🍄': 'a spotted mushroom', '🥜': 'peanuts', '🌰': 'a chestnut',
    // Bröd & Bakverk
    '🍞': 'a loaf of bread', '🥐': 'a croissant', '🥖': 'a baguette',
    '🫓': 'flatbread', '🥨': 'a pretzel', '🥯': 'a bagel',
    '🥞': 'pancakes', '🧇': 'a waffle', '🧀': 'a wedge of cheese',
    '🍖': 'a meat bone', '🍗': 'a chicken drumstick', '🥩': 'a steak',
    '🥓': 'crispy bacon',
    // Snabbmat
    '🍔': 'a hamburger', '🍟': 'french fries', '🍕': 'a pizza slice',
    '🌭': 'a hot dog', '🥪': 'a sandwich', '🌮': 'a taco',
    '🌯': 'a burrito', '🫔': 'a tamale', '🥙': 'a pita sandwich',
    '🧆': 'falafel', '🥚': 'an egg', '🍳': 'eggs in a frying pan',
    '🥘': 'paella', '🍲': 'a pot of stew', '🫕': 'a fondue pot',
    '🥣': 'a bowl of cereal', '🥗': 'a green salad', '🍿': 'popcorn',
    '🧈': 'butter', '🧂': 'salt', '🥫': 'canned food',
    '🍱': 'a bento box', '🍘': 'a rice cracker', '🍙': 'a rice ball',
    '🍚': 'steamed rice', '🍛': 'curry rice', '🍜': 'steaming noodles',
    '🍝': 'spaghetti', '🍠': 'roasted sweet potato', '🍢': 'oden',
    '🍣': 'sushi', '🍤': 'fried shrimp', '🍥': 'fish cake',
    '🍡': 'dango', '🍦': 'soft ice cream', '🍧': 'shaved ice',
    '🍨': 'ice cream', '🍩': 'a doughnut', '🍪': 'a cookie',
    '🎂': 'a birthday cake', '🍰': 'a slice of cake', '🧁': 'a cupcake',
    '🥧': 'a pie', '🍫': 'a chocolate bar', '🍬': 'candy',
    '🍭': 'a lollipop',
    // Drycker
    '🍮': 'custard pudding', '🍯': 'a honey pot', '🍼': 'a baby bottle',
    '🥛': 'a glass of milk', '☕': 'a cup of coffee', '🫖': 'a teapot',
    '🍵': 'a teacup', '🍶': 'sake', '🍾': 'a champagne bottle',
    '🍷': 'a wine glass', '🍸': 'a cocktail glass', '🍹': 'tropical drink',
    '🍺': 'a beer mug', '🍻': 'clinking beer mugs',
    // Sällskapsdjur
    '🐶': 'a cute dog', '🐱': 'a cute cat', '🐭': 'a mouse',
    '🐹': 'a hamster', '🐰': 'a rabbit', '🦊': 'a sly fox',
    '🐻': 'a brown bear', '🐼': 'a cute panda', '🐨': 'a sleepy koala',
    '🐯': 'a fierce tiger', '🦁': 'a majestic lion', '🐮': 'a cow',
    '🐷': 'a pink pig', '🐽': 'a pig nose', '🐸': 'a green frog',
    '🐵': 'a monkey face', '🐔': 'a chicken', '🐧': 'a penguin',
    '🐦': 'a bird', '🐤': 'a baby chick',
    // Vilda djur
    '🦆': 'a duck', '🦅': 'a soaring eagle', '🦉': 'a wise owl',
    '🦇': 'a bat', '🐺': 'a grey wolf', '🐗': 'a wild boar',
    '🐴': 'a horse', '🦄': 'a unicorn', '🐝': 'a honeybee',
    '🐛': 'a caterpillar', '🦋': 'a colorful butterfly', '🐌': 'a snail',
    '🐞': 'a ladybug', '🐜': 'an ant', '🦟': 'a mosquito',
    '🦗': 'a cricket', '🕷️': 'a spider', '🦂': 'a scorpion',
    '🐢': 'a turtle', '🐍': 'a snake', '🦎': 'a lizard',
    '🦖': 'a T-Rex dinosaur', '🦕': 'a sauropod dinosaur', '🐙': 'an octopus',
    '🦑': 'a squid', '🦐': 'a shrimp', '🦞': 'a lobster',
    '🦀': 'a crab', '🐡': 'a blowfish', '🐠': 'a tropical fish',
    '🐟': 'a fish', '🐬': 'a dolphin', '🐳': 'a spouting whale',
    '🐋': 'a whale', '🦈': 'a shark', '🐊': 'a crocodile',
    '🐅': 'a tiger', '🐆': 'a leopard', '🦓': 'a zebra',
    '🦍': 'a gorilla', '🦧': 'an orangutan', '🐘': 'an elephant',
    '🦛': 'a hippopotamus', '🦏': 'a rhinoceros', '🐪': 'a camel',
    '🐫': 'a two-humped camel', '🦒': 'a giraffe', '🦘': 'a kangaroo',
    '🐃': 'a water buffalo', '🐂': 'an ox', '🐄': 'a cow',
    '🐎': 'a horse', '🐖': 'a pig', '🐏': 'a ram',
    '🐑': 'a sheep', '🦙': 'a llama', '🐐': 'a goat',
    '🦌': 'a deer', '🐕': 'a dog', '🐩': 'a poodle',
    // Fordon
    '🚗': 'a red car', '🚕': 'a taxi', '🚙': 'a SUV',
    '🚌': 'a bus', '🚎': 'a trolleybus', '🏎️': 'a racing car',
    '🚓': 'a police car', '🚑': 'an ambulance', '🚒': 'a fire truck',
    '🚐': 'a minivan', '🛻': 'a pickup truck', '🚚': 'a delivery truck',
    '🚛': 'an articulated lorry', '🚜': 'a tractor', '🦯': 'a white cane',
    '🦽': 'a manual wheelchair', '🦼': 'a motorized wheelchair', '🛴': 'a kick scooter',
    '🚲': 'a bicycle', '🛵': 'a motor scooter', '🏍️': 'a motorcycle',
    '🛺': 'an auto rickshaw', '🚨': 'a police car light', '🚔': 'a police car',
    '🚍': 'an oncoming bus', '🚘': 'an oncoming automobile', '🚖': 'an oncoming taxi',
    '🚡': 'aerial tramway', '🚠': 'a mountain cableway', '🚟': 'a suspension railway',
    '🚃': 'a railway car', '🚋': 'a tram car', '🚞': 'a mountain railway',
    '🚝': 'a monorail', '🚄': 'a high-speed train', '🚅': 'a bullet train',
    '🚈': 'a light rail', '🚂': 'a steam locomotive', '🚆': 'a train',
    '🚇': 'a subway', '🚊': 'a tram', '🚉': 'a train station',
    '✈️': 'an airplane', '🛫': 'an airplane departure', '🛬': 'an airplane arrival',
    '🛩️': 'a small airplane', '💺': 'a seat', '🛰️': 'a satellite',
    // Sport
    '⚽': 'a soccer ball', '🏀': 'a basketball', '🏈': 'an american football',
    '⚾': 'a baseball', '🥎': 'a softball', '🎾': 'a tennis ball',
    '🏐': 'a volleyball', '🏉': 'a rugby ball', '🥏': 'a flying disc',
    '🎱': 'a billiard ball', '🪀': 'a yo-yo', '🏓': 'ping pong',
    '🏸': 'badminton', '🏒': 'ice hockey', '🏑': 'field hockey',
    '🥍': 'lacrosse', '🏏': 'cricket', '🥅': 'a goal net',
    '⛳': 'a golf flag', '🪁': 'a kite', '🏹': 'a bow and arrow',
    '🎣': 'a fishing rod', '🤿': 'a diving mask', '🥊': 'a boxing glove',
    '🥋': 'a martial arts uniform', '🎽': 'a running shirt',
    // Musik & Konst
    '🎨': 'an artist palette', '🎬': 'a clapper board', '🎤': 'a microphone',
    '🎧': 'headphones', '🎼': 'a musical score', '🎹': 'a musical keyboard',
    '🥁': 'a drum', '🎷': 'a saxophone', '🎺': 'a trumpet',
    '🎸': 'a guitar', '🪕': 'a banjo', '🎻': 'a violin',
    '🎲': 'a game die', '🎯': 'a direct hit', '🎳': 'bowling',
    '🎮': 'a video game controller', '🎰': 'a slot machine', '🧩': 'a puzzle piece',
    '🧸': 'a teddy bear', '🪅': 'a piñata',
    // Väder & Himmel
    '⭐': 'a golden star', '🌟': 'a glowing star', '✨': 'sparkles',
    '⚡': 'a lightning bolt', '🔥': 'flames', '💥': 'a collision',
    '☄️': 'a comet', '☀️': 'a bright sun', '🌤️': 'sun behind small cloud',
    '⛅': 'sun behind cloud', '🌦️': 'sun behind rain cloud', '☁️': 'a fluffy cloud',
    '🌧️': 'rain cloud', '⛈️': 'cloud with lightning and rain', '🌩️': 'cloud with lightning',
    '❄️': 'a snowflake', '🌨️': 'snow cloud', '☃️': 'a snowman',
    '⛄': 'a snowman without snow', '🌬️': 'wind face',
    // Geografi
    '💨': 'wind', '💧': 'a water droplet', '☔': 'an umbrella with rain',
    '☂️': 'a red umbrella', '🌊': 'an ocean wave', '🌫️': 'fog',
    '🌍': 'planet Earth', '🌎': 'the Americas', '🌏': 'Asia & Australia',
    '🪨': 'a rock', '🌑': 'new moon', '🌒': 'waxing crescent moon',
    '🌓': 'first quarter moon', '🌔': 'waxing gibbous moon', '🌕': 'full moon',
    '🌖': 'waning gibbous moon', '🌗': 'last quarter moon', '🌘': 'waning crescent moon',
    '🌙': 'a crescent moon', '🌚': 'new moon face', '🌛': 'first quarter moon face',
    '🌜': 'last quarter moon face', '🌡️': 'a thermometer', '🌝': 'full moon face',
    '🌞': 'sun with face', '🪐': 'the planet Saturn',
    // Trädgård & Natur
    '🌸': 'a cherry blossom', '💮': 'a white flower', '🏵️': 'a rosette',
    '🌹': 'a red rose', '🥀': 'a wilted flower', '🌺': 'a hibiscus flower',
    '🌻': 'a sunflower', '🌼': 'a daisy', '🌷': 'a pink tulip',
    '🌱': 'a seedling', '🪴': 'a potted plant', '🌲': 'an evergreen tree',
    '🌳': 'a deciduous tree', '🌴': 'a palm tree', '🌵': 'a cactus',
    '🌾': 'sheaf of rice', '🌿': 'an herb', '☘️': 'a shamrock',
    '🍀': 'a four-leaf clover', '🍁': 'a maple leaf', '🍂': 'fallen leaves',
    '🍃': 'leaf fluttering in wind', '🍄': 'a mushroom', '🌰': 'a chestnut',
    '🦀': 'a crab', '🦞': 'a lobster', '🐚': 'a spiral shell',
    // Byggnader
    '🏠': 'a house', '🏡': 'a house with garden', '🏢': 'an office building',
    '🏣': 'a post office', '🏤': 'a bank', '🏥': 'a hospital',
    '🏦': 'a bank building', '🏨': 'a hotel', '🏩': 'a love hotel',
    '🏪': 'a convenience store', '🏫': 'a school', '🏬': 'a department store',
    '🏭': 'a factory', '🏯': 'a Japanese castle', '🏰': 'a European castle',
    '💒': 'a wedding chapel', '🗼': 'the Tokyo tower', '🗽': 'the Statue of Liberty',
    '⛪': 'a church', '🕌': 'a mosque', '🕍': 'a synagogue',
    '⛩️': 'a shinto shrine', '🕋': 'the Kaaba', '⛲': 'a fountain',
    '⛺': 'a tent', '🌁': 'foggy bridge', '🌃': 'night with stars',
    '🏙️': 'a cityscape', '🌄': 'sunrise over mountains', '🌅': 'a sunrise',
    '🌆': 'cityscape at dusk', '🌇': 'a sunset', '🌉': 'a bridge at night',
    '♨️': 'hot springs',
    // Objekt — Ljus & Verktyg
    '💡': 'a light bulb', '🔦': 'a flashlight', '🕯️': 'a candle',
    '🪔': 'a diya lamp', '🧯': 'a fire extinguisher', '🛢️': 'an oil drum',
    '💸': 'money with wings', '💵': 'a dollar bill', '💴': 'a yen bill',
    '💶': 'a euro bill', '💷': 'a pound bill', '🪙': 'a coin',
    '💰': 'a money bag', '💳': 'a credit card', '💎': 'a gem stone',
    '⚖️': 'a balance scale', '🪜': 'a ladder', '🧰': 'a toolbox',
    '🪛': 'a screwdriver', '🔧': 'a wrench', '🔨': 'a hammer',
    '⚒️': 'a hammer and pick', '🛠️': 'a hammer and wrench', '⛏️': 'a pickaxe',
    '🪚': 'a carpentry saw', '🔩': 'a nut and bolt', '⚙️': 'a gear',
    '🪤': 'a mouse trap', '🧱': 'a brick', '⛓️': 'chains',
    '🧲': 'a magnet', '🔫': 'a water pistol', '💣': 'a bomb',
    '🔪': 'a kitchen knife', '🗡️': 'a dagger', '⚔️': 'crossed swords',
    '🛡️': 'a shield', '🚬': 'a cigarette', '⚰️': 'a coffin',
    '🏺': 'an amphora', '⚱️': 'a funeral urn', '🧿': 'a nazar amulet',
    '🔮': 'a crystal ball', '🪄': 'a magic wand', '💈': 'a barber pole',
    '⚗️': 'an alembic', '🔭': 'a telescope', '🔬': 'a microscope',
    '🕳️': 'a hole', '💊': 'a pill', '💉': 'a syringe',
    '🩸': 'a drop of blood', '🩹': 'an adhesive bandage',
    // Hjärtan
    '❤️': 'a red heart', '🧡': 'an orange heart', '💛': 'a yellow heart',
    '💚': 'a green heart', '💙': 'a blue heart', '💜': 'a purple heart',
    '🖤': 'a black heart', '🤍': 'a white heart', '🤎': 'a brown heart',
    '💔': 'a broken heart', '❣️': 'a heart exclamation', '💕': 'two hearts',
    '💞': 'revolving hearts', '💓': 'a beating heart', '💗': 'a growing heart',
    '💖': 'a sparkling heart', '💘': 'a heart with arrow', '💝': 'a heart with ribbon',
    '💟': 'a heart decoration', '☮️': 'a peace symbol',
    // Symboler
    '✝️': 'a cross', '☪️': 'a star and crescent', '🕉️': 'the Om symbol',
    '☸️': 'the wheel of dharma', '✡️': 'the Star of David', '🔯': 'a six-pointed star',
    '🕎': 'a menorah', '☯️': 'the yin-yang', '☦️': 'an orthodox cross',
    '🛐': 'a place of worship', '⛎': 'the Ophiuchus zodiac', '♈': 'Aries',
    '♉': 'Taurus', '♊': 'Gemini', '♋': 'Cancer',
    '♌': 'Leo', '♍': 'Virgo', '♎': 'Libra',
    '♏': 'Scorpio', '♐': 'Sagittarius', '♑': 'Capricorn',
    '♒': 'Aquarius', '♓': 'Pisces', '🆔': 'an ID button',
    '⚛️': 'the atom symbol', '🉑': 'a Japanese acceptable button', '☢️': 'radioactive',
    '☣️': 'biohazard', '📴': 'mobile phone off', '📳': 'vibration mode',
    '🈶': 'a Japanese not free button', '🈚': 'a Japanese free button',
    '🈸': 'a Japanese application button', '🈺': 'a Japanese open button',
    // Människor
    '👶': 'a baby', '👧': 'a girl', '🧒': 'a child',
    '👦': 'a boy', '👩': 'a woman', '🧑': 'a person',
    '👨': 'a man', '👩‍🦱': 'a woman with curly hair', '🧑‍🦱': 'a person with curly hair',
    '👨‍🦱': 'a man with curly hair', '👩‍🦰': 'a woman with red hair', '🧑‍🦰': 'a person with red hair',
    '👨‍🦰': 'a man with red hair', '👱‍♀️': 'a blond woman', '👱': 'a blond person',
    '👱‍♂️': 'a blond man', '👩‍🦳': 'a woman with white hair', '🧑‍🦳': 'a person with white hair',
    '👨‍🦳': 'a man with white hair', '👩‍🦲': 'a bald woman', '🧑‍🦲': 'a bald person',
    '👨‍🦲': 'a bald man', '🧔‍♀️': 'a bearded woman', '🧔': 'a bearded person',
    '🧔‍♂️': 'a bearded man', '👵': 'an old woman', '🧓': 'an older person',
    '👴': 'an old man', '👲': 'a man with skullcap', '👳‍♀️': 'a woman wearing turban',
    '👳': 'a person wearing turban', '👳‍♂️': 'a man wearing turban', '🧕': 'a woman with headscarf',
    '👮': 'a police officer',
    // Kläder
    '👕': 'a t-shirt', '👖': 'a pair of jeans', '🧣': 'a scarf',
    '🧤': 'gloves', '🧥': 'a coat', '🦺': 'a safety vest',
    '👚': 'a woman shirt', '👗': 'a dress', '👘': 'a kimono',
    '🥻': 'a sari', '🩱': 'a one-piece swimsuit', '🩲': 'swim briefs',
    '🩳': 'shorts', '👙': 'a bikini', '👛': 'a purse',
    '👜': 'a handbag', '👝': 'a clutch bag', '🛍️': 'shopping bags',
    '🎒': 'a backpack', '🩴': 'a thong sandal'
};
